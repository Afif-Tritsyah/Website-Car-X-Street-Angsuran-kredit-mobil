...
<html lang="en">
  ...
  <head>
    <title>Car X Street &mdash; Test one </title>
    <meta charset="utf-8">
      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-3 ">
              <div class="site-logo">
                <a href="index.html">Car X Street</a>
              </div>
            </div>
...
<div id="kalkulator" class="container my-5">
        <h2 class="text-center mb-4">Angsuran Kredit Car X Street</h2>
        <form action="" method="POST">
            <div class="mb-3">
                <label for="hargaMobil" class="form-label">Harga Mobil (Rp):</label>
                <input type="number" class="form-control" id="hargaMobil" name="hargaMobil" required>
            </div>
            <div class="mb-3">
                <label for="dpPersen" class="form-label">DP (%) :</label>
                <input type="number" class="form-control" id="dpPersen" name="dpPersen" required>
            </div>
            <div class="mb-3">
                <label for="tenorTahun" class="form-label">Tenor (Tahun):</label>
                <input type="number" class="form-control" id="tenorTahun" name="tenorTahun" required>
            </div>
            <button type="submit" name="hitung" class="btn btn-primary w 50">Hitung Angsuran</button>
        </form>
    </div>


    <!-- Output Hasil Perhitungan -->
    <div id="output" class="container my-4">
        <?php
        if (isset($_POST['hitung'])) {
            ...
            // Validasi input
            if ($hargaMobil > 0 && $dpPersen >= 0 && $tenorTahun > 0) {
                // Hitung bunga 20%
                $bunga = $hargaMobil * 0.2;

                // Hitung DP dalam bentuk nominal rupiah
                $dpNominal = $hargaMobil * ($dpPersen / 100);

                // Hitung tenor dalam bulan
                $tenorBulan = $tenorTahun * 12;

                // Hitung total pinjaman setelah DP
                ...
                // Tampilkan hasil
                echo "<p>Harga Mobil: Rp " . number_format($hargaMobil, 2, ',', '.') . "</p>";
                echo "<p>DP (%): $dpPersen%</p>";
                echo "<p>DP (Rp): Rp " . number_format($dpNominal, 2, ',', '.') . "</p>";
                echo "<p>Tenor: $tenorTahun tahun ($tenorBulan bulan)</p>";
                echo "<p>Bunga (20%): Rp " . number_format($bunga, 2, ',', '.') . "</p>";
                echo "<p>Angsuran Per Bulan: Rp " . number_format($angsuranPerBulan, 2, ',', '.') . "</p>";
            } else {
                echo "<p>Mohon masukkan nilai yang valid.</p>";
            }
        }
        ?>
    </div>
